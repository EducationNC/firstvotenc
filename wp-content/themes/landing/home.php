...
<section class="white-bg">
  <div class="container text-center partners">
    ...
    <a href="http://carolinak12.org/" target="_blank"><img src="<?php echo Assets\asset_path('images/Carolina_K12.png'); ?>" srcset="<?php echo Assets\asset_path('images/Carolina_K12@2x.png'); ?> 2x" alt="NC Civic Education Consortium" /></a>
